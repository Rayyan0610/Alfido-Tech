	        ...
	        for (int i = 1; i <= rounds; i++) {
	            ...
	            switch (limits) {
	                case 1: {
	                    ...
	                    int randomNumber = 1 + randnum.nextInt(100);
	                    ...
	                    whileloop: while (true) {
	                        ...
	                        if (guess > randomNumber) {
	                            ...
	                            System.out.println(
	                                    "Hurrey you guessed it right ! The Number" +guess+" is EQUAL to the Generated Number.\nCongrats it took you "
	                                            + count + " attempts.");
	                            break whileloop;
	                        }
	                        count++;
